...
table td{
   padding: 8px 0;
    ...
    <h1 class="text-center mb-4">Tambah Tiket Pesawat</h1>
            ...
            <form action="/insertdata" method="POST">
              @csrf
               ...
               <div class="mb-3">
                    ...
                    <input type="number"  name="NomorTelepon" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
               </div>
               <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">AsalDaerah</label>
                    <input type="text"  name="AsalDaerah" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
               </div>
